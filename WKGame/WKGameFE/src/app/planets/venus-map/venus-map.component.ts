...
@Component({
  selector: 'app-venus-map',
  templateUrl: './venus-map.component.html',
  styleUrls: ['./venus-map.component.css']
})
export class VenusMapComponent implements OnInit,  AfterViewInit {
  ...
  private initMap(): void {
    ...
    var feedback = L.latLng([-60, 160]);
    var training = L.latLng([-170, 100]);
